...
%% forward filtering fluent Acceptable

%% go is the acceptable action when
%% robot is not at the box2 position
...
%% push is the acceptable action when
%% robot is not at the position
